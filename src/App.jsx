            ...
            <motion.div initial={{ opacity: 0, y: "100%" }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: "100%" }} transition={{ type: "tween", duration: 0.3 }} className="fixed inset-0 z-50 flex flex-col bg-g-surface shadow-elevation-3">
              ...
              <div className="p-8 pt-0">
                <button 
                  ...
                  className="w-full h-16 bg-g-primary text-white font-bold uppercase tracking-wider rounded-2xl shadow-elevation-2 active:scale-95 transition-colors duration-200 ripple disabled:opacity-50 disabled:bg-g-outline"
                >
                  Seal Entry
                </button>
              </div>
